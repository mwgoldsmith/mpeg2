...
packuswb  %%mm0, %%mm0          # B6 B4 B2 B0 _ B6 B4 B2 B0                 \n\
packuswb  %%mm1, %%mm1          # R6 R4 R2 R0 _ R6 R4 R2 R0                 \n\
packuswb  %%mm2, %%mm2          # G6 G4 G2 G0 _ G6 G4 G2 G0                 \n\
                                                                            \n\
# Limit RGB odd to 0..255                                                   \n\
packuswb  %%mm3, %%mm3          # B7 B5 B3 B1 _ B7 B5 B3 B1                 \n\
packuswb  %%mm4, %%mm4          # R7 R5 R3 R1 _ R7 R5 R3 R1                 \n\
packuswb  %%mm5, %%mm5          # G7 G5 G3 G1 _ G7 G5 G3 G1                 \n\
                                                                            \n\
...
#define MMX_UNPACK_16RGB "                                                  \n\
                                                                            \n\
# mask unneeded bits off                                                    \n\
pand      mmx_bluemask, %%mm0   # b7b6b5b4 b3______ b7b6b5b4 b3______       \n\
...
psllw     mmx_greenshift,%%mm2  # ________ __g7g6g5 g4g3g2__ ________       \n\
por       %%mm2, %%mm0          # r7r6r5r4 r3g7g6g5 g4g3g2b7 b6b5b4b3       \n\
movq      %%mm0, (%0)           # store pixel 0-3                           \n\
                                                                            \n\
# convert rgb24 plane to rgb16 pack for pixel 0-3                           \n\
