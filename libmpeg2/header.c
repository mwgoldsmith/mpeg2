...
static ALIGNED_ARRAY(const uint8_t, 16) default_intra_quantizer_matrix[64]  = {
    8,
    16, 16,
    19, 16, 19,
    22, 22, 22, 22,
...
ALIGNED_ARRAY(uint8_t, 16) mpeg2_scan_norm[64] = {
...
ALIGNED_ARRAY(uint8_t, 16) mpeg2_scan_alt[64] = {
