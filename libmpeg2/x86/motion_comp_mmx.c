...
static inline void MC_avg_y_mmx(const int width, int height, uint8_t *dest, const uint8_t *ref, const int stride) {
  const uint8_t *ref_next = ref + stride;
...
static inline void MC_put_y_mmx(const int width, int height, uint8_t *dest, const uint8_t *ref, const int stride) {
  const uint8_t *ref_next = ref + stride;
...
static inline void MC_put1_8(int height, uint8_t *dest, const uint8_t *ref, const int stride) {
  do {
    movq_m2r (ref, mm0);
    movq_r2m (mm0, dest);
    ref += stride;
...
static inline void MC_put1_16(int height, uint8_t *dest, const uint8_t *ref, const int stride) {
  do {
    volatile auto _eax = ref + 8;
    volatile auto _ebx = dest + 8;
    movq_m2r(ref, mm0);
    movq_m2r(_eax, mm1);
    ref += stride;
    movq_r2m(mm0, dest);
...
static inline void MC_avg1_8(int height, uint8_t *dest, const uint8_t *ref, const int stride, const int cpu) {
  do {
    movq_m2r(ref, mm0);
    pavg_m2r(dest, mm0);
    ref += stride;
...
static inline void MC_avg1_16(int height, uint8_t *dest, const uint8_t *ref, const int stride, const int cpu) {
  do {
    volatile auto _eax = ref + 8;
    volatile auto _ebx = dest + 8;
    movq_m2r(ref, mm0);
...
static inline void MC_put2_8(int height, uint8_t *dest, const uint8_t *ref, const int stride, const int offset, const int cpu) {
  do {
    volatile auto _eax = ref + offset;
    movq_m2r(ref, mm0);
    pavg_m2r(_eax, mm0);
    ref += stride;
    movq_r2m(mm0, dest);
...
static inline void MC_put2_16(int height, uint8_t *dest, const uint8_t *ref, const int stride, const int offset, const int cpu) {
  do {
    volatile auto _eax = ref + 8;
    movq_m2r(ref, mm0);
    movq_m2r(_eax, mm1);
...
static inline void MC_avg2_8(int height, uint8_t *dest, const uint8_t *ref, const int stride, const int offset, const int cpu) {
  do {
    volatile auto _eax = ref;
    movq_m2r(_eax, mm0);
    _eax += offset;
    pavg_m2r(_eax, mm0);
    pavg_m2r(dest, mm0);
...
static inline void MC_avg2_16(int height, uint8_t *dest, const uint8_t *ref, const int stride, const int offset, const int cpu) {
  do {
    volatile auto _eax = ref + 8;
    movq_m2r(ref, mm0);
    movq_m2r(_eax, mm1);
...
static inline void MC_put4_8(int height, uint8_t *dest, const uint8_t *ref, const int stride, const int cpu) {
  movq_m2r(ref, mm0);

  volatile auto _eax = ref + 1;
  movq_m2r(_eax, mm1);
  movq_r2r(mm0, mm7);
  pxor_r2r(mm1, mm7);
  pavg_r2r(mm1, mm0);
...
static inline void MC_put4_16(int height, uint8_t *dest, const uint8_t *ref, const int stride, const int cpu) {
  do {

    volatile auto _eax = ref;
    volatile auto _ebx = dest;
...
static inline void MC_avg4_8(int height, uint8_t *dest, const uint8_t *ref, const int stride, const int cpu) {
  do {
    volatile auto _eax = ref;
    volatile auto _ebx = dest;
